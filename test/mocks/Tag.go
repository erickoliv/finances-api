...
func (_m *Tag) Delete(ctx context.Context, pk uuid.UUID, owner uuid.UUID) error {
...
func (_m *Tag) Get(ctx context.Context, pk uuid.UUID, owner uuid.UUID) (*domain.Tag, error) {
	ret := _m.Called(ctx, pk, owner)

	var r0 *domain.Tag
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, uuid.UUID) *domain.Tag); ok {
		r0 = rf(ctx, pk, owner)
	} else {
		if ret.Get(0) != nil {
...
func (_m *Tag) Query(ctx context.Context, filters *rest.Query) ([]*domain.Tag, error) {
	ret := _m.Called(ctx, filters)

	var r0 []*domain.Tag
	if rf, ok := ret.Get(0).(func(context.Context, *rest.Query) []*domain.Tag); ok {
		r0 = rf(ctx, filters)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*domain.Tag)
...
func (_m *Tag) Save(ctx context.Context, tag *domain.Tag) error {
